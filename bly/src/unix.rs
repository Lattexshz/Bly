...
/// Create a backend for XLib and store it in UnixBackend
...
/// Create a backend for Wayland and store it in UnixBackend
...
/// Structure to recognize backends for Unix as the same type
#[doc(hidden)]
